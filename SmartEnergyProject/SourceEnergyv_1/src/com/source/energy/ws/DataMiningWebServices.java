 ...
 *
 */
public class DataMiningWebServices {
	/**
	...
	// Save for FAVORITE
	//static private String URL = "http://170.224.165.29/DeviceConfigurationWS/services/AirConditionerConfig?wsdl";
	
	static private String URL = "http://localhost:8080/DeviceConfigurationWS/services/AirConditionerConfig?wsdl";
	
	public double getNormalTemperature(long DeviceID){
		return 55.5;
	}
	
	public double getThresholdTemperature(long DeviceID){
		return 55.5;
	}
	...
	public boolean IsNormalPatternMatch(){
		return true;
	}	
	...
	public DataMiningWebServices(String keyWord, String category,
			Activity activity) {
